...
import click
from utils import load_krp_file, get_lap_data
...
Feel free to watch code at [https://github.com/scls19fr/krp_python_telemetry](https://github.com/scls19fr/krp_python_telemetry)
            ...
            for col in df.columns:
                if col not in ["Time", "Distance", "Laptime", "PosX", "PosY", "Lap", "Starttime"]:
                    index = "Distance"
                    laps = df["Lap"].unique()
                    ...
                    for lap in laps[1:]:
                        ...
                        fig.add_scatter(x=df_lap.index, y=df_lap[col], mode='lines', name=str(lap))
            ...
            return html.Div([html.H3("Tab content analyse"), *graphs])
        elif tab == "tab-laps":
            return html.Div(
                [
